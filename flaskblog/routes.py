...
@app.route("/user/<string:username>") #route to website page "home". 
def user_posts(username):
    ...
    return render_template('user_posts.html',posts=posts, user=user) # return information from home.html,input(variable) posts=xxx goes to home.html
