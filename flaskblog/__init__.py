...
app.config['SQLALCHEMY_DATABASE_URI'] ='postgresql://postgres:somerabbit@ec2-23-21-215-184.compute-1.amazonaws.com:5432/dd71doth8gopgh?sslmode=require"' #set databse URI at sqlite  #'sqlite:///site.db' # 
