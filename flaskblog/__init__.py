...
app.config['SQLALCHEMY_DATABASE_URI'] ='sqlite:///site.db' #'postgresql+psycopg2://postgres:somerabbit@ec2-23-21-215-184.compute-1.amazonaws.com:5432/flaskblog?sslmode=require'   #set databse URI at sqlite  #'sqlite:///site.db' # 
